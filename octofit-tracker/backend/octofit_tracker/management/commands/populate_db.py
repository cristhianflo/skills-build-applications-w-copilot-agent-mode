...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # Create workouts
        Workout.objects.create(name='Full Body Blast', description='A full body workout for all heroes.')
        Workout.objects.create(name='Agility Training', description='Improve your agility and reflexes.')
